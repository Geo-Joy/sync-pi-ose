...
echo "Upgrading SYNC OSE..."

echo "Ensuring proper permission is set..."
sudo chown -R pi:pi $SYNC
sudo chown -R pi:pi /home/pi/sync_assets
...
sudo pip install -r $SYNC/requirements.txt -q

echo "Running migration..."
python $SYNC/misc/migrate.py
