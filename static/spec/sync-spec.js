...
(function() {
  describe("SYNC Open Source", function() {
    it("should have a SYNC object at its root", function() {
      return expect(SYNC).toBeDefined();
    });
    ...
    describe("Models", function() {
      return describe("Asset model", function() {
        ...
        it("should exist", function() {
          return expect(SYNC.Asset).toBeDefined();
        });
        ...
        it("should rollback to backup data if it exists", function() {
          ...
          return expect(asset.get('uri')).toBe("http://www.syncapp.com");
        });
    ...
    describe("Collections", function() {
      return describe("Assets", function() {
        it("should exist", function() {
          return expect(SYNC.Assets).toBeDefined();
        });
        it("should use the Asset model", function() {
          var assets;
          assets = new SYNC.Assets();
          return expect(assets.model).toBe(SYNC.Asset);
        });
    ...
    return describe("Views", function() {
      it("should have EditAssetView", function() {
        return expect(SYNC.View.EditAssetView).toBeDefined();
      });
      it("should have AssetRowView", function() {
        return expect(SYNC.View.AssetRowView).toBeDefined();
      });
      return it("should have AssetsView", function() {
        return expect(SYNC.View.AssetsView).toBeDefined();
      });
    });
  });
